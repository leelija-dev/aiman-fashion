<?php $__env->startSection('source', 'Bill History'); ?>
<?php $__env->startSection('page-title', 'Print Bill'); ?>
<?php $__env->startSection('title'); ?>
<?php echo e(config('app.name')); ?> - Bill History
            ...
            <div class="card shadow-sm border-0">
                <div class="p-4">
                    <div class="col-12 d-flex flex-md-nowrap flex-wrap gap-2 justify-content-between">
                        <form method="GET" action="<?php echo e(route('admin.print-bill')); ?>" class="col-lg-6 col-md-9 col-12 d-flex  gap-2 flex-sm-nowrap flex-wrap justify-content-sm-start justify-content-end">
                            <div class="w-100">
                            ...
                            <div>
                                <a href="<?php echo e(route('admin.print-bill')); ?>" class="btn btn-danger mb-0">Reset</a>
                            </div>
                        </form>
                        <div class="w-100 w-md-auto">
                            <a href="<?php echo e(route('admin.new-bill')); ?>" class="btn btn-primary ms-sm-0 w-100 w-md-auto">
                        ...
                        <table class="table align-middle mb-0" id="billsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo e(date_format($invoice->bill_date, 'd M, Y') ?? $invoice->bill_date); ?></td>
                                    <td class="text-center"><?php echo e($invoice->shop->shop_name ?? 'Unknown Shop'); ?></td>
                                    <td class="text-center"><?php echo e($invoice->total_items); ?></td>
                                    <td class="text-center"><?php echo e(config('app.rupees')); ?><?php echo e($invoice->total_amount); ?></td>
                                    
                                    
                                    <td class="text-center"><?php echo e(config('app.rupees')); ?><?php echo e($invoice->paid_amount ? $invoice->paid_amount : 0); ?></td>
                                    <td class="text-center">
                                        <?php echo e(config('app.rupees')); ?><?php echo e(number_format($invoice->total_amount - ($invoice->paid_amount + $invoice->discount_amount), 2)); ?>

                                    </td>

                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <button class="btn btn-outline-primary mb-0" onclick="viewBill(<?php echo e($invoice->id); ?>)">View</button>
                                            <button class="btn btn-primary mb-0" onclick="printBill(<?php echo e($invoice->id); ?>)">Print</button>
                                        </div>
                                    </td>
                                </tr>
...
<script>
    ...
    const bills = <?php echo json_encode($billsData, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aiman\resources\views/Admin/print-bill/index.blade.php ENDPATH**/ ?>